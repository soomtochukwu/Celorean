          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass p-6 rounded-lg border border-primary/10 glow-border">
              ...
              <p className="text-muted-foreground">
                Prove your identity and credentials without revealing sensitive
                information using zero-knowledge proofs.
              </p>
            </div>
            ...
            <div className="glass p-6 rounded-lg border border-primary/10 glow-border">
              ...
              <p className="text-muted-foreground">
                Personalized learning paths and content recommendations based on
            ...
            <div className="glass p-6 rounded-lg border border-primary/10 glow-border">
              ...
              <p className="text-muted-foreground">
                Your learning achievements and credentials are securely stored
                on the blockchain, ensuring authenticity and immutability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="glass p-8 md:p-12 rounded-lg border border-primary/10 glow-border text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join Celorean today and experience the future of education powered
              by blockchain and AI technology.
            </p>
      ...
      <footer className="glass border-t border-primary/10 py-8">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-primary/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Celorean. All rights reserved.
            </p>
